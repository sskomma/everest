 ...
 *
 * Algorithm: Knuth-Morris-Pratt(KMP) Pattern matching. The complexity of this algorith is O(m+n), where m is the length of text and n is the length
 * of pattern
 *
 * Thanks to Tushar Roy, his video helped me understand this algorithm. https://www.youtube.com/watch?v=GTJr8OvyEVQ
 *
 * @author Ram Komma
 */
public class SubStringSearch {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(finder.match_pattern_in_text("wwwwwwwwwwwwwww", "ww"));
    ...
    ArrayList<Integer> match_pattern_in_text(String text, String pattern) {
        // Write your code here.
        ArrayList<Integer> indices = new ArrayList<>();
        int[] kmpPattern = computeTemporaryArray(pattern.toCharArray());
        int j = 0, i=0;
        while(i< text.length()) {
